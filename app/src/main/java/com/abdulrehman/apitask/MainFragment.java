...
//    HorizontalRecyclerViewAdapter Hadapter;
    ...
    MainFragment(ArrayList<VerticalModel> arrayListVertical) {
        this.arrayListVertical = arrayListVertical;
    }

    public static MainFragment getInstance(ArrayList<VerticalModel> arrayListVertical) {
        return new MainFragment(arrayListVertical);
    }
